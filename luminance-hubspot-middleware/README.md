...
Uses OAuth tokens passed from HubSpot CRM cards via the `Authorization` header.
...
The middleware uses this token to authenticate with HubSpot's API for the specific customer portal.
